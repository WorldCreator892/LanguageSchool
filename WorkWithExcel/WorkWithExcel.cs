...
{
    public class WorkWithExcel : ILanguageSchoolSaveReader
    {
        ...
        public void WriteLanguageSchoolToExcel(LanguageSchool languageSchool, string saveAs)//Для записи 1 школы в excel
        {
            Microsoft.Office.Interop.Excel.Application app = new Microsoft.Office.Interop.Excel.Application();
            app.Visible = true;
            Dictionary<int, string> people = new Dictionary<int, string>();
        ...
        public LanguageSchool Read(string readFrom)
        {
